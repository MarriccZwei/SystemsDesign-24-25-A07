...
def TakeOffFieldLength(WSaxis):
    return WSaxis, (1.15*thrustLapse.thrustLapse(0)*np.sqrt(WSaxis/(acparams.TAKEOFF_LENGTH*acparams.K_T*acparams.RHO_LAND*acparams.g*np.pi*acparams.ASPECT*acparams.OSWALD)) + 44/acparams.TAKEOFF_LENGTH)
