...
ribBetweenCounts = [3, 0, 0, 1, 7, 3, 0, 5, 0] #amount of ribs between the ribs from ribStations
...
thicknesses = {'f':0.012, 'r':0.012, 'b':0.012, 't':0.012, 'm':0.01}
