...
def maxFunctionFinder(constraints):
    allFunctions = constraints #constains lists of the values of each function for all values of W/S
    ...
    for j in range(cutoff,10000-1): #finds the functions with the biggest value at each W/S
        biggest = 0
        maxFunction.append(0)
        for k in range(2,len(constraints)):
